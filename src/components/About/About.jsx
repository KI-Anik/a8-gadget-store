  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="text-lg leading-7 text-gray-700 text-center">
        Welcome to <span className='text-purple-500 text-xl'>Gadget Heaven</span>, your ultimate destination for the latest gadgets and accessories. 
      ...
      <div className="mt-8">
        ...
        <p className="text-lg leading-7 text-gray-700 text-center">
          At Gadget Heaven, we envision a world where technology seamlessly integrates into daily life, 
